<?php
/**
 * WXR importer class used in the Century ToolKit plugin.
 * Needed to extend the TCY_Importer_WXR_Importer class to get/set the importer protected variables,
 * for use in the multiple AJAX calls.
 *
 * @package Century ToolKit
 */

class TCY_WXR_Importer extends TCY_Importer_WXR_Importer {
	...
	/**
	 * Get all protected variables from the TCY_Importer_WXR_Importer needed for continuing the import.
	 */
	...
	/**
	 * Sets all protected variables from the TCY_Importer_WXR_Importer needed for continuing the import.
	 *
