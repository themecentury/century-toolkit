<?php
/**
 * Logger class used in the Century ToolKit plugin
 *
 * @package Century ToolKit
 */

// Include files.
if ( ! class_exists( 'TCY_Importer_Logger' ) ) {
	require TCY_ABSPATH. 'inc/importer/class-logger.php';
}
if ( ! class_exists( 'TCY_Importer_Logger_CLI' ) ) {
	require TCY_ABSPATH. 'inc/importer/class-logger-cli.php';
}


class TCY_Logger extends TCY_Importer_Logger_CLI {
	...
	/**
	 * Overwritten log function from TCY_Importer_Logger_CLI.
	 *
